...
// Assuming the object has a property 'username'
const username = connectedUser.username;

// Find the HTML element where the username will be displayed
let usernameElement = document.getElementById('username');

// Set the text content of the element to the username
